    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSearch.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (lists!=null){
                    Kecheng kecheng = lists.get(pos);
                    intent.putExtra("bean",kecheng);
                }
                        ...
                        .setPositiveButton("确定",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog,
                                                        int which) {
                                        pos = position;
                                        xuanke(lists.get(position).getId() + "");
                                    }
                                }).show();
                return false;
            }
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    if (!arrlist.equals("") && !arrlist.equals("arrlist") && !arrlist.equals("[]")) {
                        ...
                        if (arrlist.equals("1")) {
                            Toast.makeText(KechengListViewActivity.this, "选课成功",
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(KechengListViewActivity.this, "选课失败，请重新选择",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                } catch (JSONException e) {
